...
<div class="menu">
    <div class="menu-link col-xs-3  {{ request()->route()->getName() === 'home' ? 'active' : '' }}" style="width: 20%">
        <a id="homeIcn" href="{{ route('home') }}"><img src="{{ asset('assets/img/icon-menu-home' . (request()->route()->getName() === 'home' ? '-active' : '') . '.png') }}"></a>
    ...
    <div class="menu-link col-xs-3 {{ request()->route()->getName() === 'contest' || request()->route()->getName() === 'contest_detail' ? 'active' : '' }}" style="width: 20%">
        ...
        <img src="{{ asset('assets/img/Group 169' . (request()->route()->getName() === 'contest' || request()->route()->getName() === 'contest_detail' ? '-active' : '') . '.png') }}">
        </a>
    ...
    <div class="menu-link col-xs-3{{ request()->route()->getName() === 'matches' ? 'active' : '' }}" style="width: 20%">
        <a id="MatchIcn" href="{{ route('matches') }}"><img src="{{ asset('assets/img/Group 168' . (request()->route()->getName() === 'matches' ? '-active' : '') . '.png') }}"></a>
    ...
    <div class="menu-link col-xs-3 {{ request()->route()->getName() === 'league' ? 'active' : '' }}" style="width: 20%">
        <a id="leagueIcn" href="{{ route('league') }}"><img src="{{ asset('assets/img/Group 167' . (request()->route()->getName() === 'league' ? '-active' : '') . '.png') }}"></a>
    ...
    <div class="menu-link col-xs-3 {{ request()->route()->getName() === 'newss' ? 'active' : '' }}" style="width: 20%">
        <a id="newsIcn" href="{{ route('newss') }}"><img src="{{ asset('assets/img/Group 166' . (request()->route()->getName() === 'newss' ? '-active' : '') . '.png') }}"></a>
