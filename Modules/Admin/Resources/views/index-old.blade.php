<!DOCTYPE html>
<!-- 
Template Name: Admin - Responsive Admin Dashboard Template build with Twitter Bootstrap 3.3.6
Version: 4.5.3
Author: Matainja
Website: http://www.matainja.com/
Contact: support@matainja.com
Follow: www.twitter.com/matainja
Like: www.facebook.com/matainja
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset">
                    <div class="login-bg" style="background-image:url(http://localhost/newjazz/assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="{{ asset('/assets/pages/img/login/logo.png')}}" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset">
                    <div class="login-content">
                        <h1>Slypee Admin Login</h1>
                        <p> Lorem ipsum dolor sit amet, coectetuer adipiscing elit sed diam nonummy et nibh euismod aliquam erat volutpat. Lorem ipsum dolor sit amet, coectetuer adipiscing. </p>
                        <form action="{{ url('admin/submit') }}" class="login-form" method="post">
                            {!! csrf_field() !!}
                        ...
                        <form class="forget-form" action="{{ url('admin/create') }}" method="post">
