    ...
    <table id="example2" class="table tx-center display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr id="example">
                ...
                <td> {{$data['prize_size']}}</td>

                <td> {{$data['start_date']}}</td>
                <td> {{$data['end_date']}}</td>
                <td>
                    <input type="checkbox" class="winnerPrizeStatus" data-reward_id="{{$data['id']}}" @if ($data['status'] == 1) checked @endif data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="primary" data-offstyle="warning">
                </td>
                <td>
