...
$(document).ready(function() {
    ...
    function GetMatches()
    {
        ...
        $.ajax({
            ...
            data : {  start_date : start_date,end_date : end_date,type : type, team_type:team_type, league:leauge_id},
                                            ...
                                            '<div class="d-flex j-center">'+
                                                '<div class="club-left mx-1 text-center">'+
                                                    '<a href="'+baseurl+'/team/details/'+data['homeTeam_id']+'">'+
                                                        '<div class="logo">'+
                                                            '<img src="'+data['homeTeam_image']+'" alt="Home Team">'+
                                                        '</div>'+
                                                    '</a>'+
                                                ...
                                                '<div class="club-right mx-1 text-center">'+
                                                    '<a href="'+baseurl+'/team/details/'+data['awayTeam_id']+'">'+
                                                        '<div class="logo">'+
                                                            '<img src="'+data['awayTeam_image']+'" alt="Away Team">'+
                                                        '</div>'+
                                                    '</a>'+
    ...
    if (session == "") {
        $('#howToPlay').modal({backdrop: false, keyboard: false});
        console.log("here");
